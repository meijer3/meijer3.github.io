    ...
    <q-dialog v-model="visible" full-height  @hide="$router.push('/')" >
      <q-card class="project-card text-center"  >
        ...
        <q-card-section  style="max-height: calc(100% - 72px);" class="scroll"  >
            ...
            <q-img alt="FME generated Meshnetwork on IMDF" style="max-height:50vh"   src="../assets/img/mesh.png" />
            ...
            <q-img alt="Beacons bluetooth" style="max-height:50vh"   src="../assets/img/beacons.png" />
