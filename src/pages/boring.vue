    ...
    <q-dialog v-model="visible" full-height  @hide="$router.push('/')" >
      <q-card class="project-card text-center"  >
        ...
        <br><br>
          ...
          <div class="row">
              <q-img src="img/boring_1.png" class="col-8" alt="A borehole sheet example"  style="max-height:50vh" contain /><q-img src="img/boring_4.png" alt="A borehole sheet example"  style="max-height:50vh" contain  class="col-4"/>
          </div>
          ...
          <div class="row">
            ...
            <q-img src="img/boring_2.png" alt="A borehole sheet example"  style="max-height:50vh" contain  class="col-4" />
            </div>
